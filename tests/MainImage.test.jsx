...
describe("useAllData", () => {
    it("Calls useAllData on render", () => {
        ...
        const mockSelectCharacterPositionPut = vi.fn(() => ({})); 

        render(<MainImage useAllData={mockUseAllData} selectCharacterPositionPut={mockSelectCharacterPositionPut} submitScorePut={() => ({})} />);
...
describe("selectCharacterPositionPut", () => {
    afterEach(() => {
        vi.restoreAllMocks();
    });
    ...
    it("Gets called when character is clicked", async () => {
        ...
        expect(mockSelectCharacterPositionPut)
            .toHaveBeenCalled();
    })
...
describe("CharacterMarker", () => {
    ...
    it("Can render multiple charactermarkers", async () => {
        ...
        const mockSelectCharacterPositionPut = vi.fn((characterId) => {
            if (characterId === 4) {
                return {
                    success: true,
                    characterId: 4,
...
describe("submitScorePut", () => {
    it("Calls submitScoreForm when user wins & submits form", async () => {
        ...
        render(<MainImage useAllData={mockUseAllData} selectCharacterPositionPut={mockSelectCharacterPositionPut} submitScorePut={mockSubmitScorePut} />);
...
describe("Winner submission errors", () => {
    ...
    it("Renders form with winner form label", async () => {
        const mockUseAllData = getUseAllDataMock(false, false, {
            imageSrc: "/",
            imageAlt: "Test Alt Text",
            characters: [
        ...
        expect(screen.queryByLabelText("winner form"))
            .toBeInTheDocument();
    })

    it("Shows error message on 400 status", async () => {
        const mockUseAllData = getUseAllDataMock(false, false, {
            imageSrc: "/",
            imageAlt: "Test Alt Text",
            characters: [
        ...
        await user.type(nameInput, "Test Invalid Name");
        ...
        const winnerForm = screen.queryByLabelText("winner form");

        expect(within(winnerForm).queryByText(/Test Form Error Message/i))
            .toBeInTheDocument();
    })
})